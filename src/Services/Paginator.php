...
class Paginator {
    ...
    /**
     * Le nombre de locations à récupérer par page
     *
     * @var integer
     */
    private $limit = 6;
    ...
    /**
     * L'entityManager de Doctrine qui nous permet notamment de trouver le repository dont on a besoin
     *
    ...
    /**
     * Le chemin vers le template qui contient la pagination à renseigner dans security.yaml en arguments lors de la déclaration du service pagination
     *
     * @var string
     */
